...
const CTASection = () => {
  return (
    <section id="kontak" className="py-8 relative overflow-hidden">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-10 max-w-2xl mx-auto leading-relaxed">
            Tim kami siap membantu Anda menemukan kendaraan yang tepat dan
            memberikan layanan terbaik untuk Mitsubishi Anda.
          </p>
