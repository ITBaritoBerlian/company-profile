...
const services = [
  {
    ...
    description: "Konsultasi kebutuhan pribadi & bisnis dengan pilihan unit terlengkap dari Mitsubishi Motors & FUSO.",
    color: "text-primary",
  },
  {
    icon: Wrench,
    title: "Servis Berkala",
    description: "Teknisi tersertifikasi dengan peralatan standar pabrikan untuk perawatan optimal kendaraan Anda.",
    color: "text-primary",
  },
  {
    icon: PackageCheck,
    title: "Suku Cadang Asli",
    description: "Jaminan keaslian & garansi pabrikan untuk semua suku cadang yang kami sediakan.",
    color: "text-primary",
  },
  {
    icon: Paintbrush,
    title: "Bodi & Cat",
    description: "Perbaikan panel & pengecatan profesional dengan hasil finishing sempurna seperti baru.",
    color: "text-primary",
  },
];
...
const Services = () => {
  return (
    <section id="layanan" className="py-20 bg-muted/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Didukung teknisi tersertifikasi dan fasilitas modern untuk kepuasan pelanggan
          </p>
        </div>
